...
class SimulationGUI(tk.Tk):
    ...
    def simulate_day(self):
        if not self.simulation_started:
            # Первый лог состояний перед началом
        ...
        # 1. Сначала сбрасываем цвета всех нод в белый перед шагом (опционально)
        # или обновляем их СРАЗУ после расчёта.
        # 1. Выполняем шаг в модели (инкапсулировано!)
        try:
        ...
        # 4. Обновление цветов агентов на основе их эмоций
    ...
    def add_random_agent(self):
        """Добавляет случайного агента, используя логику коллектива."""
